<?php get_header(); ?>
  <!-- responsible for view the home page , as we defined in the setting-Reading
  so the default is that the home page is the same blog page but if u want to make them sipriable
  go and create 2 page one home and one blog for the links and go to settings-reading and change the 
  post page to blog and the home to home,
  so then the home will be the front-page.php and the blog will be the index.php file -->
